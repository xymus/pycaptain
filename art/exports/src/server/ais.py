...
from utils import * # distBetween, angleBetween, areOver, distBetweenObjects, angleBetweenObjects, angleDiff, distLowerThanObjects, distLowerThanReturn
from objects import Object, Asteroid, Sun, Nebula
from ships import Ship # , FlagShip
from weapons import *
